    ...
    var footerHTML =
      '<div class="footer-inner">' +
        '<div class="footer-brand">' +
          '<div class="nav-logo"><img src="img/logo.jpg" alt="CPMC couvreur Aix"/><span class="nav-logo-text" style="color:#fff;">CP<span style="color:var(--orange)">MC</span></span></div>' +
          '<p>Couverture de Provence Maçonnerie Construction – Artisan couvreur qualifié, Le Tholonet (13100). Toiture, zinguerie, maçonnerie sur Bouches-du-Rhône, Var, Vaucluse.</p>' +
        '</div>' +
        ...
        '<div class="footer-col"><h4>Contact</h4>' +
          '<div class="footer-contact-item">' + ICONS.phone + '<span><a href="tel:0666768602">06 66 76 86 02</a></span></div>' +
          '<div class="footer-contact-item">' + ICONS.mail + '<span><a href="mailto:cpmc13100@gmail.com">cpmc13100@gmail.com</a></span></div>' +
          '<div class="footer-contact-item">' + ICONS.location + '<span>Route de Langesse<br>13100 Le Tholonet</span></div>' +
        '</div>' +
      '</div>' +
      '<div class="footer-bottom"><span>&copy; 2026 <span>CPMC</span> – Couverture de Provence Maçonnerie Construction</span><span>Artisan couvreur – Le Tholonet 13100</span></div>';
